                ...
                <div className="p-5 space-y-5 container">
                    ...
                    <div className="bg-amber-300 rounded-xl p-5">
                        <label className="text-2xl leading-loose text-justify">
                            ...
                            لپ تاپ می‌کنند؛ تا مشکل اصلی آن را پیدا کرده و تشخیص
                            دهند که قطعه معیوب شده قابل تعمیر است یا باید تعویض
                            شود. سپس براساس همین اطلاعات هزینه تعمیر لپ تاپ را
                            برآورد کرده و به کاربر اطلاع می‌دهد. پس از آن اگر
                            کاربر تمایل داشت، پروسه تعمیرات تخصصی لپ تاپ را آغاز
                            می‌کنند؛ درنهایت نیز با تست و بررسی نهایی سیستم، از
                            رفع مشکل آن اطمینان حاصل می‌کنند و لپ تاپ کاربر را
                            مانند روز اول در اختیارش قرار می‌دهند. اگر شما هم با
                            مشکلی در لپ تاپتان مواجه شده‌اید و به دنبال مرکزی
                            هستید تا لپ تاپ شما را به صورت تخصصی تعمیر کند،
