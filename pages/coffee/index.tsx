                ...
                <div className="container w-full p-5 space-y-5">
                    ...
                    <div className="bg-white p-10 text-3xl leading-relaxed flex flex-col space-y-5 items-center justify-center">
                        ...
                        <label className="text-center">
                            مجموعه کافه کارآفرینی دارای محیطی آرام و دنج جهت
                            مطالعه و استفاده به عنوان فضای اشتراکی کاری و انواع
                            نوشیدنی های سرد و گرم ، غذا های گرم
                            (فیله،اسنک،پاستا) ، آماده ارائه خدمات به شهروندان
