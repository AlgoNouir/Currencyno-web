                ...
                <div className="p-5 space-y-5 sm:container">
                    ...
                    <div className="bg-amber-300 rounded-xl p-5">
                        <label className="text-sm sm:text-xl lg:text-2xl leading-loose text-justify">
                            ...
                            به‌عنوان یک کارفرما به دنبال نیروی ماهر و توانمند
                            هستید میتوانید بر روی ما حساب کنید. کارنسینو می‌کوشد
                            با انتشار آگهی‌های شغلی، فراخوان‌ها و اخبار استخدام
                            سراسر کشور در کنار ارائه بروزترین امکانات، متدها و
                            ابزارهای جذب و استخدام، محیطی حرفه‌ای و کارآمد برای
                            ارتباط کارجو و کارفرما برقرار کرده است. شما میتوانید
                            به عنوان کارفرما یا کارجو در قسمت مشخص شده در سایت
                            فرم ثبتنام خود را پر کنید. اگر کارجو هستید پس از
                            ثبتنام ما با شما تماس گرفته و در مورد شغل انتخابی
                            صحبت خواهیم کرد و اگر مورد تایید شما بود ، جلسه ای
                            را برای ارتباط شما با کارفرما مشخص خواهیم کرد. اگر
                            کارفرما هستید اگهی مربوط به شغل خود را ثبت کرده و
                            اطلاعات خود را بصوت کامل وارد نمایید سپس بقیه کار را
                            به ما بسپارید ما نیروی متخصص با شغل شمارا برای شما
                            پیدا میکنیم.
                        </label>
                    </div>
                    <Banner images={[""]} />
